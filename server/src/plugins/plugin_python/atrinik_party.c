 ...
 * Party fields.
 */
static fields_struct fields[] = {{"name",
                                  FIELDTYPE_SHSTR,
                                  offsetof(party_struct, name),
                                  FIELDFLAG_READONLY,
                                  0,
                                  "Name of the party.; str (readonly)"},
                                 {"leader",
                                  FIELDTYPE_SHSTR,
                                  offsetof(party_struct, leader),
                                  0,
                                  0,
                                  "Name of the party's leader (a player name).; str"},
                                 {"password",
                                  FIELDTYPE_CARY,
                                  offsetof(party_struct, passwd),
                                  FIELDFLAG_READONLY,
                                  0,
                                  "Password required to join the party.; str"}};
...
static PyObject *Atrinik_Party_SendMessage(Atrinik_Party *self, PyObject *args) {
    ...
    hooks->send_party_message(self->party,
                              msg,
                              flags,
                              ob != NULL ? ob->obj : NULL,
                              exclude != NULL ? exclude->obj : NULL);
...
PyTypeObject Atrinik_PartyType = {
    PyVarObject_HEAD_INIT(NULL, 0).tp_name = "Atrinik.Party",
