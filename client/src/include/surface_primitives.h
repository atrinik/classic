...
extern bool surface_set_transparent_black(SDL_Surface *surface);
extern bool surface_set_transparent_black_mutable(SDL_Surface *surface);
extern bool surface_clear_transparent_black(SDL_Surface *surface);
